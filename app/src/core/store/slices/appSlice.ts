...
export interface IAppData {
    ...
    searchInListSoftwareTitle: string;
...
export const appSlice = createSlice({
    ...
    reducers: {
        ...
        saveSearchInListSoftwareTitle: (state, action: PayloadAction<string>) => {
            state.searchInListSoftwareTitle = action.payload;
        },
